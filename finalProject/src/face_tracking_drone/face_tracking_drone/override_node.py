...
from std_msgs.msg import Int8 # Int8 is the message type
...
class OverrideNode(Node):
    ...
    def getKey(self):
        """
        Function that listens to keyboard inputs
        """
    ...
    def drone_override(self):
        """
        Function to parse keyboard inerrupts
        """
        ...
        def keyboard_interrupt_thread():
            while True:
                ...
                if key == 'q' or key == 'Q':
                    ...
                    print("published message to land drone")

                # break/stop-the-node if 'ctrl + c' received
                if (key == '\x03'):
                    break
