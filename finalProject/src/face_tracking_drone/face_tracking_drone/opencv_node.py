...
from std_msgs.msg import Int16MultiArray # Int16MultiArray is the message type
...
class OpenCVNode(Node):
    ...
    def listener_callback(self, data):
        ...
        Callback function.
        """
        # Display the message on the console (Debugging logs)
    ...
    def captureFace(self, img):
        """
        Funtion to capture a face in the received image frame from drone
        Face capture is done using opencv haar cascade
        """
    ...
    def trackFace(self, info, w, pid, pError):
        """
        Function to track a face and keep it centered after
